...
function Boss1AI() {
  ...
  if((this.aiData.stage === 1) && (this.aiData.enemies === 1)) {
    game.levels[currentLevel].dynamics.push(new Mob(32,16,1,1,PatrolAI,{dmg:5,x1:40.05,x2:73.95,vX:8,dir:-1},function(){bossMob.aiData.dead++; this.kill();}));
  ...
  if((this.aiData.stage === 2) && (this.aiData.enemies > 0)) {
    setTimeout(function(){
      game.levels[currentLevel].dynamics.push(new Mob(32,16,1,1,PatrolAI,{dmg:5,x1:40.05,x2:73.95,vX:15,dir:-1},function(){bossMob.aiData.dead++;this.kill();}));
      setTimeout(function(){
        game.levels[currentLevel].dynamics.push(new Mob(32,16,1,1,PatrolAI,{dmg:5,x1:40.05,x2:73.95,vX:15,dir:-1},function(){bossMob.aiData.dead++;this.kill();}));
      },1000);
    },1000);
  ...
  if((this.aiData.stage === 3) && (this.aiData.enemies > 0)) {
    setTimeout(function(){
      game.levels[currentLevel].dynamics.push(new Mob(32,16,1,1,PatrolAI,{dmg:5,x1:40.05,x2:73.95,vX:20,dir:-1},function(){bossMob.aiData.dead++;this.kill();}));
      setTimeout(function(){
        game.levels[currentLevel].dynamics.push(new Mob(32,16,1,1,PatrolAI,{dmg:5,x1:40.05,x2:73.95,vX:20,dir:-1},function(){bossMob.aiData.dead++;this.kill();}));
        setTimeout(function(){
          game.levels[currentLevel].dynamics.push(new Mob(32,16,1,1,PatrolAI,{dmg:5,x1:40.05,x2:73.95,vX:20,dir:-1},function(){bossMob.aiData.dead++;this.kill();}));
  ...
  if((this.aiData.stage === 4) && (this.aiData.enemies > 0)) {
    setTimeout(function(){
      game.levels[currentLevel].dynamics.push(new Mob(bossMob.x/u,14,1,1,PatrolAI,{dmg:5,x1:40.05,x2:73.95,vX:20,dir:-1},function(){bossMob.aiData.dead++;this.kill();}));
      setTimeout(function(){
        game.levels[currentLevel].dynamics.push(new Mob(bossMob.x/u,14,1,1,PatrolAI,{dmg:5,x1:40.05,x2:73.95,vX:20,dir:1},function(){bossMob.aiData.dead++;this.kill();}));
        setTimeout(function(){
          game.levels[currentLevel].dynamics.push(new Mob(bossMob.x/u,14,1,1,PatrolAI,{dmg:5,x1:40.05,x2:73.95,vX:20,dir:-1},function(){bossMob.aiData.dead++;this.kill();}));
